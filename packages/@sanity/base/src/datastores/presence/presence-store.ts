...
import {createJSONRpcTransport} from './message-transports/jsonRpcTransport'
...
const [events$, sendMessages] = createJSONRpcTransport<PresenceLocation[]>(CLIENT_ID)
...
export const groupedByIdentity$ = clients$.pipe(
